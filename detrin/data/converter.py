...
from detrin.utils import LOGGER, TQDM
...
def convert_coco(
    ...
    Example:
        ```python
        from detrin.data.converter import convert_coco
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    ...
    Example:
        ```python
        from detrin.data.converter import convert_segment_masks_to_yolo_seg
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from detrin.data.converter import convert_dota_to_yolo_obb
...
def yolo_bbox2segment(im_dir, save_dir=None, sam_model="sam_b.pt"):
    ...
    from detrin import SAM
    from detrin.data import YOLODataset
    from detrin.utils import LOGGER
