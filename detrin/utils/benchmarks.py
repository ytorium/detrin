...
Usage:
    from detrin.utils.benchmarks import ProfileModels, benchmark
...
from detrin import YOLO, YOLOWorld
from detrin.cfg import TASK2DATA, TASK2METRIC
from detrin.engine.exporter import export_formats
from detrin.utils import ARM64, ASSETS, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from detrin.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from detrin.utils.downloads import safe_download
from detrin.utils.files import file_size
from detrin.utils.torch_utils import select_device
...
def benchmark(
    ...
    Example:
        ```python
        from detrin.utils.benchmarks import benchmark
...
class RF100Benchmark:
    ...
    def parse_dataset(self, ds_link_txt="datasets_links.txt"):
        ...
        os.chdir("rf-100")
        os.mkdir("detrin-benchmarks")
        #tym safe_download("https://github.com/ultralytics/assets/releases/download/v0.0.0/datasets_links.txt")
...
class ProfileModels:
    ...
    Example:
        ```python
        from detrin.utils.benchmarks import ProfileModels
