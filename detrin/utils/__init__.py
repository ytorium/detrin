...
class ThreadingLocked:
    ...
    Example:
        ```python
        from detrin.utils import ThreadingLocked
...
USER_CONFIG_DIR = Path(os.getenv("YOLO_CONFIG_DIR") or get_user_config_dir())  # Detrin settings dir
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version="0.0.4"):
        ...
        from detrin.utils.torch_utils import torch_distributed_zero_first
...
from detrin.utils.patches import imread, imshow, imwrite, torch_load, torch_save
