...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from detrin.utils.checks import parse_requirements
...
def check_latest_pypi_version(package_name="detrin"):
    """
...
def check_pip_update_available():
    ...
    if ONLINE and IS_PIP_PACKAGE:
        with contextlib.suppress(Exception):
            from detrin import __version__
...
def check_requirements(requirements=ROOT.parent / "requirements.txt", exclude=(), install=True, cmds=""):
    ...
    Example:
        ```python
        from detrin.utils.checks import check_requirements
...
def check_yolo(verbose=True, device=""):
    ...
    if IS_JUPYTER:
        #tym if check_requirements("wandb", install=False):
            #tym os.system("pip uninstall -y wandb")  # uninstall wandb: unwanted account creation prompt with infinite hang
        if IS_COLAB:
...
def collect_system_info():
    ...
    from detrin.utils import ENVIRONMENT, IS_GIT_DIR
    from detrin.utils.torch_utils import get_cpu_info
    ...
    for r in parse_requirements(package="detrin"):
        try:
...
def check_amp(model):
    ...
    Example:
        ...
        from detrin.utils.checks import check_amp
    ...
    """
    from detrin.utils.torch_utils import autocast
