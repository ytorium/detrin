...
from detrin.utils import LOGGER, TryExcept, ops, plt_settings, threaded
from detrin.utils.checks import check_font, check_version, is_ascii
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from detrin.utils.plotting import save_one_box
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from detrin.utils.plotting import plot_results
