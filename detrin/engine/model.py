...
from detrin.cfg import TASK2DATA, get_cfg, get_save_dir
from detrin.engine.results import Results
from detrin.hub import HUB_WEB_ROOT, HUBTrainingSession
from detrin.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
...
class Model(nn.Module):
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from detrin.trackers import register_tracker
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from detrin.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        Examples:
            ...
            ['person', 'bicycle', 'car', ...]
        """
        from detrin.nn.autobackend import check_class_names
